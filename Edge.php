...
namespace Rufus\Edge;

use Rufus\Edge\Cache\ArrayCache;
use Rufus\Edge\Cache\CacheInterface;
use Rufus\Edge\Cache\FileCache;
use Rufus\Edge\Compiler\Compiler;
use Rufus\Edge\Compiler\CompilerInterface;
use Rufus\Edge\Concern\ManageComponentTrait;
use Rufus\Edge\Exception\EdgeException;
use Rufus\Edge\Extension\ExtensionInterface;
use Rufus\Edge\Loader\LoaderInterface;
use Rufus\Edge\Loader\StringLoader;
...
class Edge
{
     ...
     */
    public function prepareExtensions(CompilerInterface $compiler)
    {
     ...
     * @return static
     */
    public function addExtension(ExtensionInterface $extension, $name = null)
    {
        if (!$name) {
    ...
    {
        return array_key_exists($name, $this->extensions) && $this->extensions[$name] instanceof ExtensionInterface;
    }
